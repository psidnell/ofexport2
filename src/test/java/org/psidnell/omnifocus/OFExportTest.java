...
public class OFExportTest {
    ...
    public void testIncludeFolderSubtreeWhenMatch () throws Exception {
        ...
        ofExport.addFolderExpression("name=='f1'");
        ofExport.process();
        StringWriter out = new StringWriter();
        ofExport.write(out);
    ...
    public void testIncludeContextSubtreeWhenMatch () throws Exception {
        ...
        ofExport.addContextExpression("name=='c1'");
        ofExport.process();
        StringWriter out = new StringWriter();
        ofExport.write(out);
    ...
    public void testIncludeTaskWhenMatch () throws Exception {
        ...
        ofExport.addTaskExpression("+:name=='t1'");
        ofExport.process();
        StringWriter out = new StringWriter();
        ofExport.write(out);
    ...
    public void testExcludeTaskWhenMatch () throws Exception {
        ...
        ofExport.addTaskExpression("-:name=='t2'");
        ofExport.process();
        StringWriter out = new StringWriter();
        ofExport.write(out);
    ...
    public void testIncludeTaskSubTreeWhenMatch () throws Exception {
        ...
        ofExport.addTaskExpression("name=='t1' || included");
        ofExport.process();
        StringWriter out = new StringWriter();
        ofExport.write(out);
