...
<@doIndent indent=depth/>. -added:<#if (folder.added.getDate())??>${folder.added.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -dropped:${folder.dropped?c}
<@doIndent indent=depth/>. -folderCount:${folder.folderCount}
<@doIndent indent=depth/>. -modified:<#if (folder.modified.getDate())??>${folder.modified.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
...
<@doIndent indent=depth/>. -added:<#if (project.added.getDate())??>${project.added.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -completed:${project.completed?c}
<@doIndent indent=depth/>. -completion:<#if (project.completion.getDate())??>${project.completion.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -contextName:<#if (project.contextName)??>${project.contextName}<#else>null></#if>
<@doIndent indent=depth/>. -deferDate:<#if (project.defer.getDate())??>${project.defer.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -dropped:${project.dropped?c}
<@doIndent indent=depth/>. -dueDate:<#if (project.due.getDate())??>${project.due.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -estimatedMinutes:${project.estimatedMinutes}
<@doIndent indent=depth/>. -flagged:${project.flagged?c}
<@doIndent indent=depth/>. -modified:<#if (project.modified.getDate())??>${project.modified.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
...
<@doIndent indent=depth/>. -added:<#if (task.added.getDate())??>${task.added.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
...
<@doIndent indent=depth/>. -completion:<#if (task.completion.getDate())??>${task.completion.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -contextName:<#if (task.contextName)??>${task.contextName}<#else>null></#if>
<@doIndent indent=depth/>. -deferDate:<#if (task.defer.getDate())??>${task.defer.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -dueDate:<#if (task.due.getDate())??>${task.due.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
<@doIndent indent=depth/>. -estimatedMinutes:${task.estimatedMinutes}
<@doIndent indent=depth/>. -flagged:${task.flagged?c}
<@doIndent indent=depth/>. -modified:<#if (task.modified.getDate())??>${task.modified.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
...
<@doIndent indent=depth/>. -added:<#if (context.added.getDate())??>${context.added.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
...
<@doIndent indent=depth/>. -modified:<#if (context.modified.getDate())??>${context.modified.getDate()?string["yyyy-MM-dd HH:mm:ss"]}<#else>null</#if>
